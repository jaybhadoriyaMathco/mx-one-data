...
export function BuildingBlocksPage() {
  ...
  const items: SidebarEntry[] = [
    { label: "Executive", path: "/building-blocks/executive", color: "#8C7CF6" },
    { label: "Performance", path: "/building-blocks/performance", color: "#00C2FF" },
    { label: "FACT vs FCST", path: "/building-blocks/fact-vs-fcst", color: "#FF4DB8" },
  ];
